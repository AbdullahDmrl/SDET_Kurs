...
public class _03_Soru extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        islem.selectByVisibleText(dortIslem.get(random3).getText());
